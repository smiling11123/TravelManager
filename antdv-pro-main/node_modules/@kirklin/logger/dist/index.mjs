...
class ServerFormatter extends Formatter {
  ...
  doWrite(level, message) {
    if (message.fields.length === 0) {
      return doLog(level, `[%s] ${message.format}`, (/* @__PURE__ */ new Date()).toISOString(), ...message.args);
    }
    const obj = {};
...
export { BrowserFormatter, Field, Formatter, Level, Logger, ServerFormatter, Time, field, logger, time };
