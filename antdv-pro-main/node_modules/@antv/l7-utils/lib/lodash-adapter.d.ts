...
export declare const lodashUtil: {
    ...
    pull: {
        ...
        <TList extends import("lodash").MutableList<any>>(array: ((<X>() => X extends { [K in keyof TList]: TList[K]; } ? 1 : 2) extends <X_1>() => X_1 extends { -readonly [K_1 in keyof TList]: TList[K_1]; } ? 1 : 2 ? true : false) extends true ? TList : never, ...values: TList[0][]): TList;
    };
    ...
    upperFirst: <T_7 extends string = string>(string?: T_7 | undefined) => Capitalize<T_7>;
    get: {
    ...
    mergeWith: {
        <TObject_18, TSource_1>(object: TObject_18, source: TSource_1, customizer: (value: any, srcValue: any, key: string, object: any, source: any, stack: any) => any): TObject_18 & TSource_1;
        <TObject_19, TSource1_3, TSource2_3>(object: TObject_19, source1: TSource1_3, source2: TSource2_3, customizer: (value: any, srcValue: any, key: string, object: any, source: any, stack: any) => any): TObject_19 & TSource1_3 & TSource2_3;
        <TObject_20, TSource1_4, TSource2_4, TSource3_2>(object: TObject_20, source1: TSource1_4, source2: TSource2_4, source3: TSource3_2, customizer: (value: any, srcValue: any, key: string, object: any, source: any, stack: any) => any): TObject_20 & TSource1_4 & TSource2_4 & TSource3_2;
        <TObject_21, TSource1_5, TSource2_5, TSource3_3, TSource4_1>(object: TObject_21, source1: TSource1_5, source2: TSource2_5, source3: TSource3_3, source4: TSource4_1, customizer: (value: any, srcValue: any, key: string, object: any, source: any, stack: any) => any): TObject_21 & TSource1_5 & TSource2_5 & TSource3_3 & TSource4_1;
        (object: any, ...otherArgs: any[]): any;
    };
