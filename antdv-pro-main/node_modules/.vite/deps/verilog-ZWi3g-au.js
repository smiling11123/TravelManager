...
function mkVerilog(parserConfig) {
	...
	function words(str) {
		...
		for (var i$1 = 0; i$1 < words$1.length; ++i$1) obj[words$1[i$1]] = true;
		return obj;
	}
	/**
	...
	*/
	...
	function isClosing(text, contextClosing) {
		if (text == contextClosing) return true;
			...
			for (var i$1 in closingKeywords) if (text == closingKeywords[i$1]) return true;
			return false;
		}
	}
	function buildElectricInputRegEx() {
		var allClosings = [];
		for (var i$1 in openClose) if (openClose[i$1]) {
			var closings = openClose[i$1].split(";");
			for (var j in closings) allClosings.push(closings[j]);
		}
		return /* @__PURE__ */ new RegExp("[{}()\\[\\]]|(" + allClosings.join("|") + ")$");
	}
	return {
		name: "verilog",
...
//#endregion
export { verilog };
//# sourceMappingURL=verilog-ZWi3g-au.js.map