import { EditorSelection, EditorView, ExternalTokenizer, LRLanguage, LRParser, LanguageSupport, LocalTokenGroup, delimitedIndent, foldNodeProp, indentNodeProp, parseMixed, styleTags, syntaxTree, tags } from "./dist-BSjRk5ij.js";
...
function jinja(config = {}) {
	...
	let lang = base$1.language == baseHTML.language ? jinjaLanguage : makeJinja(base$1.language);
...
//#endregion
export { jinja };
//# sourceMappingURL=dist-Dn5T70gM.js.map