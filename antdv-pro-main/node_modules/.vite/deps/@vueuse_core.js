import { Fragment, TransitionGroup, computed, customRef, defineComponent, effectScope, getCurrentInstance, getCurrentScope, h, inject, isReactive, isReadonly, isRef, markRaw, nextTick, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onMounted, onScopeDispose, onUnmounted, onUpdated, provide, reactive, readonly, ref, shallowReactive, shallowRef, toRef as toRef$1, toRefs as toRefs$1, unref, version, watch, watchEffect } from "./vue.runtime.esm-bundler-CYunRHQt.js";
import { del, isVue2, isVue3, set as set$1 } from "./lib-CGZBHD41.js";
...
function set(...args) {
	...
	if (args.length === 3) if (isVue2) set$1(...args);
	else {
...
function useHorizontalVirtualList(options, list) {
	...
	const scrollTo$1 = createScrollTo("horizontal", calculateRange, getDistanceLeft, containerRef);
...
function useVerticalVirtualList(options, list) {
	...
	useWatchForSizes(size, list, containerRef, calculateRange);
	const scrollTo$1 = createScrollTo("vertical", calculateRange, getDistanceTop, containerRef);
	const wrapperProps = computed(() => {
		return { style: {
			width: "100%",
