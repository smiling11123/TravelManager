//#region node_modules/dayjs/esm/constant.js
...
//#endregion
//#region node_modules/dayjs/esm/locale/en.js
var en_default = {
	name: "en",
...
//#endregion
//#region node_modules/dayjs/esm/utils.js
var padStart = function padStart$1(string, length, pad) {
	var s = String(string);
	if (!s || s.length >= length) return string;
	return "" + Array(length + 1 - s.length).join(pad) + string;
};
var padZoneStr = function padZoneStr$1(instance) {
...
var monthDiff = function monthDiff$1(a, b) {
	if (a.date() < b.date()) return -monthDiff$1(b, a);
...
var absFloor = function absFloor$1(n) {
	return n < 0 ? Math.ceil(n) || 0 : Math.floor(n);
};
var prettyUnit = function prettyUnit$1(u) {
	return {
		M,
		y: Y,
		w: W,
...
var isUndefined = function isUndefined$1(s) {
	return s === void 0;
};
var utils_default = {
	s: padStart,
...
//#endregion
//#region node_modules/dayjs/esm/index.js
var L = "en";
var Ls = {};
Ls[L] = en_default;
var IS_DAYJS = "$isDayjsObject";
var isDayjs = function isDayjs$1(d) {
	return d instanceof Dayjs || !!(d && d[IS_DAYJS]);
};
var parseLocale = function parseLocale$1(preset, object, isLocal) {
	var l;
	if (!preset) return L;
	if (typeof preset === "string") {
		...
		if (!l && presetSplit.length > 1) return parseLocale$1(presetSplit[0]);
	} else {
...
var dayjs = function dayjs$1(date, c) {
...
var wrapper = function wrapper$1(date, instance) {
	return dayjs(date, {
		locale: instance.$L,
		utc: instance.$u,
		x: instance.$x,
...
Utils.i = isDayjs;
Utils.w = wrapper;
var parseDate = function parseDate$1(cfg) {
...
var Dayjs = /* @__PURE__ */ function() {
	function Dayjs$1(cfg) {
		this.$L = parseLocale(cfg.locale, null, true);
		this.parse(cfg);
		this.$x = this.$x || cfg.x || {};
		this[IS_DAYJS] = true;
	}
	var _proto = Dayjs$1.prototype;
	...
	_proto.startOf = function startOf(units, _startOf) {
		...
		var instanceFactory = function instanceFactory$1(d, m) {
			var ins = Utils.w(_this.$u ? Date.UTC(_this.$y, m, d) : new Date(_this.$y, m, d), _this);
			return isStartOf ? ins : ins.endOf(D);
		};
		var instanceFactorySet = function instanceFactorySet$1(method, slice) {
	...
	_proto.add = function add(number, units) {
		...
		var unit = Utils.p(units);
		var instanceFactorySet = function instanceFactorySet$1(n) {
			var d = dayjs(_this2);
	...
	_proto.format = function format(formatStr) {
		...
		var getShort = function getShort$1(arr, index, full, length) {
			return arr && (arr[index] || arr(_this3, str)) || full[index].slice(0, length);
		};
		var get$H = function get$H$1(num) {
		...
		var matches = function matches$1(match) {
			switch (match) {
	...
	_proto.diff = function diff(input, units, _float) {
		...
		var diff$1 = this - that;
		var getMonth = function getMonth$1() {
		...
		switch (unit) {
			...
			case Q:
				...
				break;
			case W:
				result = (diff$1 - zoneDelta) / MILLISECONDS_A_WEEK;
				break;
			case D:
				result = (diff$1 - zoneDelta) / MILLISECONDS_A_DAY;
				break;
			case H:
				result = diff$1 / MILLISECONDS_A_HOUR;
				break;
			case MIN:
				result = diff$1 / MILLISECONDS_A_MINUTE;
				break;
			case S:
				result = diff$1 / MILLISECONDS_A_SECOND;
				break;
			default:
				result = diff$1;
				break;
...
//#endregion
export { D, FORMAT_DEFAULT, M, MS, Q, W, Y, esm_default };
//# sourceMappingURL=esm-BD67ns7N.js.map