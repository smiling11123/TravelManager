...
function wordRegexp(words$1) {
	return /* @__PURE__ */ new RegExp("^((" + words$1.join(")|(") + "))\\b");
}
...
function mkPython(parserConf) {
	...
	function tokenBaseInner(stream, state, inFormat) {
		...
		for (var i$1 = 0; i$1 < operators.length; i$1++) if (stream.match(operators[i$1])) return "operator";
...
const cython = mkPython({ extra_keywords: words("by cdef cimport cpdef ctypedef enum except extern gil include nogil property public readonly struct union DEF IF ELIF ELSE") });

//#endregion
export { cython };
//# sourceMappingURL=python-CZQHoEEd.js.map