import { ExternalTokenizer, LRLanguage, LRParser, LanguageSupport, continuedIndent, foldNodeProp, indentNodeProp, styleTags, syntaxTree, tags } from "./dist-BSjRk5ij.js";
import { completeFromList, ifNotIn } from "./dist-C4Wus0z5.js";
...
var Space = " 	\r\n";
function keywords(keywords$1, types, builtin) {
	let result = Object.create(null);
	result["true"] = result["false"] = Bool;
	result["null"] = result["unknown"] = Null;
	for (let kw of keywords$1.split(" ")) if (kw) result[kw] = Keyword;
...
function dialect(spec, kws, types, builtin) {
	let dialect$1 = {};
	for (let prop in defaults) dialect$1[prop] = (spec.hasOwnProperty(prop) ? spec : defaults)[prop];
	if (kws) dialect$1.words = keywords(kws, types || "", builtin);
	return dialect$1;
}
...
function completeFromSchema(schema, tables, schemas, defaultTableName, defaultSchemaName, dialect$1) {
	var _a;
	let idQuote = ((_a = dialect$1 === null || dialect$1 === void 0 ? void 0 : dialect$1.spec.identifierQuotes) === null || _a === void 0 ? void 0 : _a[0]) || "\"";
	let top = new CompletionLevel(idQuote, !!(dialect$1 === null || dialect$1 === void 0 ? void 0 : dialect$1.spec.caseInsensitiveIdentifiers));
...
function completeKeywords(keywords$1, upperCase, build) {
	let completions = Object.keys(keywords$1).map((keyword) => build(upperCase ? keyword.toUpperCase() : keyword, completionType(keywords$1[keyword])));
	return ifNotIn([
		"QuotedIdentifier",
		"String",
		"LineComment",
...
var SQLDialect = class SQLDialect {
	constructor(dialect$1, language, spec) {
...
*/
function keywordCompletionSource(dialect$1, upperCase = false, build) {
	return completeKeywords(dialect$1.dialect.words, upperCase, build || defaultKeyword);
}
/**
...
//# sourceMappingURL=dist-MwhmfbNZ.js.map