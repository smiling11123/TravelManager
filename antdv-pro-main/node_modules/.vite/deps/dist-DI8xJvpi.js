import { ContextTracker, ExternalTokenizer, LRLanguage, LRParser, LanguageSupport, continuedIndent, foldInside, foldNodeProp, indentNodeProp, styleTags, tags } from "./dist-BSjRk5ij.js";
import { defineCSSCompletionSource } from "./dist-Dh21ZLBs.js";
...
var spaces = new ExternalTokenizer((input, stack) => {
	if (stack.dialectEnabled(Dialect_indented)) {
		...
		if (input.next < 0 && stack.canShift(eof)) input.acceptToken(eof);
			...
			if (input.next == newlineChar || startOfComment(input)) input.acceptToken(blankLineStart, -spaces$1);
			else if (spaces$1) input.acceptToken(whitespace);
...
//#endregion
export { sass };
//# sourceMappingURL=dist-DI8xJvpi.js.map