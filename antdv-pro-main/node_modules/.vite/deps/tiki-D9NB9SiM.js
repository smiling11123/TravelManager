...
function pushContext(pluginName$1, startOfLine) {
...
function endplugin(startOfLine) {
	return function(type$1) {
		if (type$1 == "selfclosePlugin" || type$1 == "endPlugin") return cont();
		if (type$1 == "endPlugin") {
...
function endcloseplugin(err) {
	return function(type$1) {
		if (err) setStyle = "error";
		if (type$1 == "endPlugin") return cont();
		return pass();
	};
}
function attributes(type$1) {
	if (type$1 == "keyword") {
		setStyle = "attribute";
		return cont(attributes);
	}
	if (type$1 == "equals") return cont(attvalue, attributes);
	return pass();
}
function attvalue(type$1) {
	if (type$1 == "keyword") {
		setStyle = "string";
		return cont();
	}
	if (type$1 == "string") return cont(attvaluemaybe);
	return pass();
}
function attvaluemaybe(type$1) {
	if (type$1 == "string") return cont(attvaluemaybe);
	else return pass();
}
const tiki = {
...
//#endregion
export { tiki };
//# sourceMappingURL=tiki-D9NB9SiM.js.map