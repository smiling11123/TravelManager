...
var operators = buildRegexp([wordOperators, /[+\-*\/%]=|\+\+|--|\.\.|[+\-*&^%:=!|\/]|<(?!#)|(?!#)>/], { suffix: "" });
...
function tokenInterpolation(stream, state, parentTokenize) {
	if (stream.match("$(")) {
		...
		state.returnStack.push({
			shouldReturnFrom: function(state$1) {
				return state$1.bracketNesting === savedBracketNesting;
			},
...
function tokenMultiString(stream, state) {
	...
	if (stream.sol() && stream.match(/* @__PURE__ */ new RegExp(quote + "@"))) state.tokenize = tokenBase;
...
//#endregion
export { powerShell };
//# sourceMappingURL=powershell-CNl2l3bh.js.map