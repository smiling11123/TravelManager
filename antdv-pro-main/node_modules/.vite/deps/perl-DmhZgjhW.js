...
function tokenChain(stream, state, chain, style, tail) {
	...
	state.style = null;
	state.tail = null;
	state.tokenize = function(stream$1, state$1) {
		var e = false, c, i = 0;
		while (c = stream$1.next()) {
			if (c === chain[i] && !e) {
				if (chain[++i] !== void 0) {
					state$1.chain = chain[i];
					state$1.style = style;
					state$1.tail = tail;
				} else if (tail) stream$1.eatWhile(tail);
				state$1.tokenize = tokenPerl;
				return style;
			}
			e = !e && c == "\\";
		}
...
function tokenSOMETHING(stream, state, string) {
	state.tokenize = function(stream$1, state$1) {
		if (stream$1.string == string) state$1.tokenize = tokenPerl;
		stream$1.skipToEnd();
		return "string";
	};
	return state.tokenize(stream, state);
...
//#endregion
export { perl };
//# sourceMappingURL=perl-DmhZgjhW.js.map