...
var reBaseForm = /* @__PURE__ */ new RegExp("(?:" + pBase + "(?:\\^\\^" + pFloatBase + pPrecision + "?(?:\\*\\^[+-]?\\d+)?))");
var reFloatForm = /* @__PURE__ */ new RegExp("(?:" + pFloat + pPrecision + "?(?:\\*\\^[+-]?\\d+)?)");
var reIdInContext = /* @__PURE__ */ new RegExp("(?:`?)(?:" + Identifier + ")(?:`(?:" + Identifier + "))*(?:`?)");
...
//#endregion
export { mathematica };
//# sourceMappingURL=mathematica-CM5RKOMc.js.map