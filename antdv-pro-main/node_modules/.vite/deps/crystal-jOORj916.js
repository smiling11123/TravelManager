...
function wordRegExp(words, end) {
	return /* @__PURE__ */ new RegExp((end ? "" : "^") + "(?:" + words.join("|") + ")" + (end ? "$" : "\\b"));
}
...
var dedentPunctuals = /* @__PURE__ */ new RegExp("^(?:" + dedentPunctualsArray.join("|") + ")$");
var nextTokenizer = {
...
//#endregion
export { crystal };
//# sourceMappingURL=crystal-jOORj916.js.map